...
export default function CreateProductPage() {
  ...
  const onSubmit = useCallback(
      ...
      try {
        ...
        if (filesToUpload.length > 0) {
          ...
          try {
            ...
            // Mark as uploaded — match each uploading slot to its URL by order
            let urlIndex = 0
            setImageSlots((prev) =>
              prev.map((s) => {
                if (s.status === 'uploading' && urlIndex < imageUrls.length) {
                  const remoteUrl = imageUrls[urlIndex++]
    ...
    [store?.id, imageSlots, attributeFields, productRepo, router, hasDiscount],
  )
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4 animate-in fade-in slide-in-from-left-4 duration-500">
        ...
        <div className="flex-1">
          <h1 className="text-xl font-bold text-white">Nuevo producto</h1>
          ...
          <div className="space-y-2 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-[400ms]">
            ...
            >
              {submitting ? (
                ...
                <>
                  <span className="relative z-10">Publicar producto</span>
