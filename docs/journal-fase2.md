...
**Verificación:** frontend `npx tsc --noEmit` limpio · `pnpm build` limpio, 36 rutas (bajaron 3 respecto a B7: `/acceso/movil`, `/home` y `/onboarding` — las 3 sin `page.tsx` propio, sus sub-rutas reales como `/home/terminos` y `/onboarding/create-store` siguen intactas).
