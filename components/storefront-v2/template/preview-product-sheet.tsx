...
// Detalle de producto SOLO para previews (modal de Temas / probador): en la
// tienda real cada producto navega a su página propia (/{tienda}/{producto},
// con OG) — acá los productos demo no tienen página, así que el flujo de
// muestra abre este sheet themeado por tokens, agrega al carrito y sigue al
// checkout de WhatsApp igual que en prod. zIndex 400: vive por encima del
